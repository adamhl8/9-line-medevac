import {Grid, Stack, Button, Group, Input, Box, MultiSelect, Checkbox, TextInput, NumberInput} from '@mantine/core';
import {useForm} from "@mantine/form";
import React from "react";

interface FourmsProps {
    setSubmitted : React.Dispatch<React.SetStateAction<boolean>>;
    submitted : boolean;
}

const Fourm = (props: FourmsProps) =>{
                ...
                <Stack spacing="lg" sx={(theme) => ({ backgroundColor: theme.colorScheme === 'dark' ? theme.colors.dark[8] : theme.colors.gray[0], height: 300 })}>
                    ...
                    >
                        <Checkbox.Group
                            ...
                            spacing="xs"
                            defaultValue={['None']}
                            {...form.getInputProps('SpecialEquipment')}
                        >
                    ...
                    >
                        <Checkbox.Group
                            orientation="vertical"
                            spacing="xs"
                            {...form.getInputProps('MethodOfMarkingPickupSite')}
                        >
                            <Checkbox value="None" label="None" />
                    ...
                    >
                        <MultiSelect
                            ...
                            {...form.getInputProps('NCBCContamination')}
                        />
                    </Input.Wrapper>
                    <Group>
                        <Button type="submit"  variant="light" color="red" radius="xl" size="md" uppercase onClick={()=>{props.setSubmitted(true)}} >
                            Submit
                        </Button>
                    </Group>
                </Stack>
